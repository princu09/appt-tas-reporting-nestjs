...
export class joincolumnNames1671443019806 implements MigrationInterface {
  name = 'joincolumnNames1671443019806';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "incidentflashreport" ADD "contractorId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "incidentflashreport" ADD CONSTRAINT "UQ_a437f0e3f7a0c29f4ffb19c38ae" UNIQUE ("contractorId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "safetyobservations" ADD "contractorId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "safetyobservations" ADD CONSTRAINT "UQ_66e282c3d722a19db0b7f9f9129" UNIQUE ("contractorId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "contractordatareport" ADD "contractorId" uuid NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "contractordatareport" DROP COLUMN "contractorId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "safetyobservations" DROP CONSTRAINT "UQ_66e282c3d722a19db0b7f9f9129"`,
    );
    await queryRunner.query(
      `ALTER TABLE "safetyobservations" DROP COLUMN "contractorId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "incidentflashreport" DROP CONSTRAINT "UQ_a437f0e3f7a0c29f4ffb19c38ae"`,
    );
    await queryRunner.query(
      `ALTER TABLE "incidentflashreport" DROP COLUMN "contractorId"`,
    );
  }
}
