...
import { Usertag, UsertagDTO } from './user-tag.entity';
...
@Crud({
  ...
  ...defaultCrudPermissions('Usertag'),
})
@ApiTags('usertag')
@Controller('usertag')
...
export class UsertagController implements CrudController<Usertag> {
  constructor(public service: UsertagService) {}
}
